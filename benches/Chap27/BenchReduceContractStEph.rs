...
//! Chapter 27: Reduce by contraction (sequential) benchmark.
...
fn bench_reduce_sum(c: &mut Criterion) {
    let mut group = c.benchmark_group("ReduceContractSum");
    ...
    for &n in &[64usize, 256] {
        ...
        group.bench_with_input(BenchmarkId::new("n", n), &n, |b, _| {
            b.iter(|| {
                <ArraySeqStEphS<usize> as ReduceContractStEphTrait<usize>>::reduce_contract(
                    &a,
