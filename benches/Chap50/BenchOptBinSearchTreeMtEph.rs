...
//! Chapter 50: Optimal binary search tree (multi-threaded, ephemeral) benchmark.
...
fn bench_obst_mt_eph(c: &mut Criterion) {
    set_parallelism(10);
    let mut group = c.benchmark_group("OBSTMtEph");
        ...
        group.bench_with_input(BenchmarkId::new("n_keys", n), &n, |b, &n| {
            b.iter_batched(
                || {
                    ...
                    OBSTMtEphS::<u64>::from_keys_probs(keys, probs)
                },
...
criterion_group!(benches, bench_obst_mt_eph);
