...
//! Chapter 51: Top-down DP (multi-threaded, ephemeral) benchmark.
...
fn bench_top_down_dp_mt(c: &mut Criterion) {
    set_parallelism(10);
    let mut group = c.benchmark_group("TopDownDPMtEph");
    ...
    for &n in &[20usize, 40] {
        group.bench_with_input(BenchmarkId::new("n_x_n", n), &n, |b, &n| {
            b.iter_batched(
                ...
                |mut dp| dp.med_memoized_parallel(),
...
criterion_group!(benches, bench_top_down_dp_mt);
