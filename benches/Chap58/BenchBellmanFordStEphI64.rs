...
//! Chapter 58: Bellman-Ford SSSP (sequential, ephemeral) benchmark.
...
fn bench_bellman_ford(c: &mut Criterion) {
    let mut group = c.benchmark_group("BellmanFordStEphI64");
...
criterion_group!(benches, bench_bellman_ford);
