...
//! Chapter 59: Johnson all-pairs shortest paths (multi-threaded, ephemeral, f64 weights) benchmark.
...
fn bench_johnson_mt_f64(c: &mut Criterion) {
    set_parallelism(10);
    let mut group = c.benchmark_group("JohnsonMtEphF64");
...
criterion_group!(benches, bench_johnson_mt_f64);
