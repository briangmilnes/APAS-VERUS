...
//! Chapter 59: Johnson all-pairs shortest paths (sequential, ephemeral, f64 weights) benchmark.
...
fn bench_johnson_f64(c: &mut Criterion) {
    let mut group = c.benchmark_group("JohnsonStEphF64");
...
criterion_group!(benches, bench_johnson_f64);
