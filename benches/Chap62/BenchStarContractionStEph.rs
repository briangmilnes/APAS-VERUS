...
//! Chapter 62: Star contraction (sequential, ephemeral) benchmark.
...
fn bench_contract_to_vertices(c: &mut Criterion) {
    let mut group = c.benchmark_group("StarContractionStEph");
    ...
    for &n in &[16usize, 32] {
        ...
        group.bench_with_input(BenchmarkId::new("n", n), &n, |b, _| {
            b.iter(|| contract_to_vertices(&graph));
        });
    }
    group.finish();
}

criterion_group!(benches, bench_contract_to_vertices);
