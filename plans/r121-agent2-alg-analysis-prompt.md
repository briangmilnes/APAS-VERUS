# R121 Agent 2 — Review and rewrite algorithmic analysis comments (Chap21-37). AFK. DOT.
...
Chap21, Chap23, Chap26, Chap27, Chap28, Chap30, Chap35, Chap36, Chap37
...
- No subagents.
- Validate after: `scripts/validate.sh isolate Chap37` to confirm you didn't
...
Write `plans/agent2-r121-alg-analysis-report.md`. Per chapter: number of
