# R122 Agent 3 — Algorithmic analysis: verify APAS + independent code review (Chap40-51). AFK. DOT.
...
Chap40, Chap41, Chap42, Chap43, Chap44, Chap45, Chap47, Chap49, Chap50, Chap51

Note: Chap43 and Chap47 have two prose files each (ChapNNpart2.txt). Read both.
...
Write `plans/agent3-r122-alg-analysis-report.md`. Per chapter: functions
