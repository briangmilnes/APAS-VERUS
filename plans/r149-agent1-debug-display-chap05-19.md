# R149 Agent 1 — Add Missing Debug/Display Impls: Chap02-Chap19. AFK.
...
Report file: `plans/r149-agent1-debug-display-report.md`
...
Expected ~140 [14] warnings in these chapters.

## How to find the warnings

Run this to get your specific warnings:
