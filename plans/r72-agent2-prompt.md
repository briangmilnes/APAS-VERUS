# R72 Agent 2 — PTT Iterator Coverage (Chap37 Mt modules, part 1)

## Objective

Create iterator PTTs for Chap37 Mt modules. Each PTT proves the iterator's
...
1. `src/Chap37/AVLTreeSeqMtPer.rs`
2. `src/Chap37/BSTSetAVLMtEph.rs`
3. `src/Chap37/BSTSetBBAlphaMtEph.rs`
