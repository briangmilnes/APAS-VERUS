//! Proof tests for RelationStEph iterators
//!
...
test_verify_one_file! {
    #[test] relationsteph_loop_borrow_iter verus_code! {
        use vstd::prelude::*;
        ...
        {
            let r: RelationStEph<u64, u64> = RelationLit![(1u64, 10u64), (2u64, 20u64)];
...
test_verify_one_file! {
    #[test] relationsteph_loop_borrow_into verus_code! {
        use vstd::prelude::*;
        use apas_verus::Types::Types::{Pair, valid_key_type_Pair};
        use apas_verus::Chap05::SetStEph::SetStEph::SetStEphTrait;
        use apas_verus::Chap05::RelationStEph::RelationStEph::*;
            ...
            requires valid_key_type_Pair::<u64, u64>()
        {
            ...
            let mut it: RelationStEphIter<u64, u64> = (&r).into_iter();
            let ghost iter_seq: Seq<Pair<u64, u64>> = it@.1;
            let ghost mut items: Seq<Pair<u64, u64>> = Seq::empty();
...
// for-borrow-iter: `for x in iter: a.iter()`
test_verify_one_file! {
    #[test] relationsteph_for_borrow_iter verus_code! {
        use vstd::prelude::*;
        use apas_verus::Types::Types::{Pair, valid_key_type_Pair};
        use apas_verus::Chap05::SetStEph::SetStEph::SetStEphTrait;
        use apas_verus::Chap05::RelationStEph::RelationStEph::*;
        ...
        fn test_for_borrow_iter()
            requires valid_key_type_Pair::<u64, u64>()
        {
            let r: RelationStEph<u64, u64> = RelationLit![(10u64, 100u64), (20u64, 200u64)];
...
// for-borrow-into: `for x in iter: (&a).into_iter()`
test_verify_one_file! {
    #[test] relationsteph_for_borrow_into verus_code! {
        use vstd::prelude::*;
        use apas_verus::Types::Types::{Pair, valid_key_type_Pair};
        use apas_verus::Chap05::SetStEph::SetStEph::SetStEphTrait;
        use apas_verus::Chap05::RelationStEph::RelationStEph::*;
            ...
            requires valid_key_type_Pair::<u64, u64>()
        {
            ...
            let it: RelationStEphIter<u64, u64> = (&r).into_iter();
            let ghost iter_seq: Seq<Pair<u64, u64>> = it@.1;
            let ghost mut items: Seq<Pair<u64, u64>> = Seq::empty();
