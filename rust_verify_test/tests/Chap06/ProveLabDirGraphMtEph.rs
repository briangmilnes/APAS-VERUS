//! Proof tests for LabDirGraphMtEph iterators
//!
...
test_verify_one_file! {
    #[test] labdirgraphmteph_loop_borrow_iter_vertices verus_code! {
        use vstd::prelude::*;
            ...
            requires valid_key_type_for_lab_graph::<u64, u64>()
        {
            ...
            let g = LabDirGraphMtEph::from_vertices_and_labeled_arcs(verts, arcs);
...
test_verify_one_file! {
    #[test] labdirgraphmteph_loop_borrow_iter_arcs verus_code! {
        use vstd::prelude::*;
        use apas_verus::Types::Types::*;
        use apas_verus::Chap05::SetStEph::SetStEph::*;
        use apas_verus::Chap06::LabDirGraphMtEph::LabDirGraphMtEph::*;
...
test_verify_one_file! {
    #[test] labdirgraphmteph_for_borrow_iter_vertices verus_code! {
        use vstd::prelude::*;
        use apas_verus::Types::Types::*;
        use apas_verus::Chap05::SetStEph::SetStEph::*;
        use apas_verus::Chap06::LabDirGraphMtEph::LabDirGraphMtEph::*;
...
test_verify_one_file! {
    #[test] labdirgraphmteph_for_borrow_iter_arcs verus_code! {
        use vstd::prelude::*;
        use apas_verus::Types::Types::*;
        use apas_verus::Chap05::SetStEph::SetStEph::*;
        use apas_verus::Chap06::LabDirGraphMtEph::LabDirGraphMtEph::*;
