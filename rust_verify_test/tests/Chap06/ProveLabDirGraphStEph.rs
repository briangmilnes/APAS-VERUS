//! Proof tests for LabDirGraphStEph iterators
//!
...
test_verify_one_file! {
    #[test] labdirgraphsteph_loop_borrow_iter_vertices verus_code! {
        use vstd::prelude::*;
            ...
            requires valid_key_type_LabEdge::<u64, u64>()
        {
            ...
            let _ = arcs.insert(LabEdge(1u64, 2u64, 100u64));

            let g = LabDirGraphStEph::from_vertices_and_labeled_arcs(verts, arcs);
...
test_verify_one_file! {
    #[test] labdirgraphsteph_loop_borrow_iter_arcs verus_code! {
        use vstd::prelude::*;
        use apas_verus::Types::Types::*;
        use apas_verus::Chap05::SetStEph::SetStEph::*;
        use apas_verus::Chap06::LabDirGraphStEph::LabDirGraphStEph::*;
...
test_verify_one_file! {
    #[test] labdirgraphsteph_for_borrow_iter_vertices verus_code! {
        use vstd::prelude::*;
        use apas_verus::Types::Types::*;
        use apas_verus::Chap05::SetStEph::SetStEph::*;
        use apas_verus::Chap06::LabDirGraphStEph::LabDirGraphStEph::*;
            ...
            requires valid_key_type_LabEdge::<u64, u64>()
        {
            ...
            let mut arcs: SetStEph<LabEdge<u64, u64>> = SetStEph::empty();
            let _ = arcs.insert(LabEdge(10u64, 20u64, 99u64));
...
test_verify_one_file! {
    #[test] labdirgraphsteph_for_borrow_iter_arcs verus_code! {
        use vstd::prelude::*;
        use apas_verus::Types::Types::*;
        use apas_verus::Chap05::SetStEph::SetStEph::*;
        use apas_verus::Chap06::LabDirGraphStEph::LabDirGraphStEph::*;
