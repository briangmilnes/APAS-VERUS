//! Proof tests for WeightedDirGraphStEphI128 iterators
//!
...
test_verify_one_file! {
    #[test] weighteddirgraphstephi128_loop_borrow_iter_vertices verus_code! {
        use vstd::prelude::*;
        ...
        fn test_loop_borrow_iter_vertices()
            requires valid_key_type_LabEdge::<u64, i128>()
        {
            let mut verts: SetStEph<u64> = SetStEph::empty();
            let _ = verts.insert(1);
            let _ = verts.insert(2);

            let mut arcs: SetStEph<LabEdge<u64, i128>> = SetStEph::empty();
            let _ = arcs.insert(LabEdge(1u64, 2u64, 5i128));

            let g: WeightedDirGraphStEphI128<u64> =
...
test_verify_one_file! {
    #[test] weighteddirgraphstephi128_loop_borrow_iter_arcs verus_code! {
        use vstd::prelude::*;
        use apas_verus::Types::Types::*;
        use apas_verus::Chap05::SetStEph::SetStEph::*;
        use apas_verus::Chap06::LabDirGraphStEph::LabDirGraphStEph::*;
            ...
            requires valid_key_type_LabEdge::<u64, i128>()
        {
            ...
            let mut it: SetStEphIter<LabEdge<u64, i128>> = g.iter_arcs();
            let ghost iter_seq: Seq<LabEdge<u64, i128>> = it@.1;
            let ghost mut items: Seq<LabEdge<u64, i128>> = Seq::empty();
...
test_verify_one_file! {
    #[test] weighteddirgraphstephi128_for_borrow_iter_vertices verus_code! {
        use vstd::prelude::*;
        use apas_verus::Types::Types::*;
        use apas_verus::Chap05::SetStEph::SetStEph::*;
        use apas_verus::Chap06::LabDirGraphStEph::LabDirGraphStEph::*;
            ...
            requires valid_key_type_LabEdge::<u64, i128>()
        {
            ...
            let mut arcs: SetStEph<LabEdge<u64, i128>> = SetStEph::empty();
            let _ = arcs.insert(LabEdge(10u64, 20u64, 9i128));
...
test_verify_one_file! {
    #[test] weighteddirgraphstephi128_for_borrow_iter_arcs verus_code! {
        use vstd::prelude::*;
        use apas_verus::Types::Types::*;
        use apas_verus::Chap05::SetStEph::SetStEph::*;
        use apas_verus::Chap06::LabDirGraphStEph::LabDirGraphStEph::*;
            ...
            requires valid_key_type_LabEdge::<u64, i128>()
        {
            ...
            let it: SetStEphIter<LabEdge<u64, i128>> = g.iter_arcs();
            let ghost iter_seq: Seq<LabEdge<u64, i128>> = it@.1;
            let ghost mut items: Seq<LabEdge<u64, i128>> = Seq::empty();
