//! Proof tests for WeightedDirGraphStEphI64 iterators
//!
...
test_verify_one_file! {
    #[test] weighteddirgraphstephi64_loop_borrow_iter_arcs verus_code! {
            ...
            requires valid_key_type_LabEdge::<u64, i64>()
        {
            ...
            let mut it: SetStEphIter<LabEdge<u64, i64>> = g.iter_arcs();
            let ghost iter_seq: Seq<LabEdge<u64, i64>> = it@.1;
            let ghost mut items: Seq<LabEdge<u64, i64>> = Seq::empty();
...
test_verify_one_file! {
    #[test] weighteddirgraphstephi64_for_borrow_iter_arcs verus_code! {
            ...
            requires valid_key_type_LabEdge::<u64, i64>()
        {
            ...
            let it: SetStEphIter<LabEdge<u64, i64>> = g.iter_arcs();
            let ghost iter_seq: Seq<LabEdge<u64, i64>> = it@.1;
            let ghost mut items: Seq<LabEdge<u64, i64>> = Seq::empty();
