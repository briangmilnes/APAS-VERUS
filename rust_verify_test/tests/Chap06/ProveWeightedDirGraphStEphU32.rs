//! Proof tests for WeightedDirGraphStEphU32 iterators
//!
...
test_verify_one_file! {
    #[test] weighteddirgraphstephu32_loop_borrow_iter_vertices verus_code! {
        use vstd::prelude::*;
        ...
        fn test_loop_borrow_iter_vertices()
            requires valid_key_type_LabEdge::<u64, u32>()
        {
            let mut verts: SetStEph<u64> = SetStEph::empty();
            let _ = verts.insert(1);
            let _ = verts.insert(2);

            let mut arcs: SetStEph<LabEdge<u64, u32>> = SetStEph::empty();
            let _ = arcs.insert(LabEdge(1u64, 2u64, 5u32));

            let g: WeightedDirGraphStEphU32<u64> =
...
test_verify_one_file! {
    #[test] weighteddirgraphstephu32_loop_borrow_iter_arcs verus_code! {
        use vstd::prelude::*;
        use apas_verus::Types::Types::*;
        use apas_verus::Chap05::SetStEph::SetStEph::*;
        use apas_verus::Chap06::LabDirGraphStEph::LabDirGraphStEph::*;
            ...
            requires valid_key_type_LabEdge::<u64, u32>()
        {
            ...
            let mut it: SetStEphIter<LabEdge<u64, u32>> = g.iter_arcs();
            let ghost iter_seq: Seq<LabEdge<u64, u32>> = it@.1;
            let ghost mut items: Seq<LabEdge<u64, u32>> = Seq::empty();
...
test_verify_one_file! {
    #[test] weighteddirgraphstephu32_for_borrow_iter_vertices verus_code! {
        use vstd::prelude::*;
        use apas_verus::Types::Types::*;
        use apas_verus::Chap05::SetStEph::SetStEph::*;
        use apas_verus::Chap06::LabDirGraphStEph::LabDirGraphStEph::*;
            ...
            requires valid_key_type_LabEdge::<u64, u32>()
        {
            ...
            let mut arcs: SetStEph<LabEdge<u64, u32>> = SetStEph::empty();
            let _ = arcs.insert(LabEdge(10u64, 20u64, 9u32));
...
test_verify_one_file! {
    #[test] weighteddirgraphstephu32_for_borrow_iter_arcs verus_code! {
        use vstd::prelude::*;
        use apas_verus::Types::Types::*;
        use apas_verus::Chap05::SetStEph::SetStEph::*;
        use apas_verus::Chap06::LabDirGraphStEph::LabDirGraphStEph::*;
            ...
            requires valid_key_type_LabEdge::<u64, u32>()
        {
            ...
            let it: SetStEphIter<LabEdge<u64, u32>> = g.iter_arcs();
            let ghost iter_seq: Seq<LabEdge<u64, u32>> = it@.1;
            let ghost mut items: Seq<LabEdge<u64, u32>> = Seq::empty();
