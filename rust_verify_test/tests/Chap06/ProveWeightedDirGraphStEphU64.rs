//! Proof tests for WeightedDirGraphStEphU64 iterators
//!
...
test_verify_one_file! {
    #[test] weighteddirgraphstephu64_loop_borrow_iter_vertices verus_code! {
        use vstd::prelude::*;
        use apas_verus::Types::Types::*;
        use apas_verus::Chap05::SetStEph::SetStEph::*;
        use apas_verus::Chap06::LabDirGraphStEph::LabDirGraphStEph::*;
        use apas_verus::Chap06::WeightedDirGraphStEphU64::WeightedDirGraphStEphU64::*;
            ...
            requires valid_key_type_LabEdge::<u64, u64>()
        {
            ...
            let mut arcs: SetStEph<LabEdge<u64, u64>> = SetStEph::empty();
            let _ = arcs.insert(LabEdge(1u64, 2u64, 5u64));

            let g: WeightedDirGraphStEphU64<u64> =
...
test_verify_one_file! {
    #[test] weighteddirgraphstephu64_loop_borrow_iter_arcs verus_code! {
        use vstd::prelude::*;
        use apas_verus::Types::Types::*;
        use apas_verus::Chap05::SetStEph::SetStEph::*;
        use apas_verus::Chap06::LabDirGraphStEph::LabDirGraphStEph::*;
            ...
            requires valid_key_type_LabEdge::<u64, u64>()
        {
            ...
            let mut it: SetStEphIter<LabEdge<u64, u64>> = g.iter_arcs();
...
test_verify_one_file! {
    #[test] weighteddirgraphstephu64_for_borrow_iter_vertices verus_code! {
        use vstd::prelude::*;
        use apas_verus::Types::Types::*;
        use apas_verus::Chap05::SetStEph::SetStEph::*;
        use apas_verus::Chap06::LabDirGraphStEph::LabDirGraphStEph::*;
            ...
            requires valid_key_type_LabEdge::<u64, u64>()
        {
            ...
            let mut arcs: SetStEph<LabEdge<u64, u64>> = SetStEph::empty();
            let _ = arcs.insert(LabEdge(10u64, 20u64, 9u64));
...
test_verify_one_file! {
    #[test] weighteddirgraphstephu64_for_borrow_iter_arcs verus_code! {
        use vstd::prelude::*;
        use apas_verus::Types::Types::*;
        use apas_verus::Chap05::SetStEph::SetStEph::*;
        use apas_verus::Chap06::LabDirGraphStEph::LabDirGraphStEph::*;
            ...
            requires valid_key_type_LabEdge::<u64, u64>()
        {
            ...
            let it: SetStEphIter<LabEdge<u64, u64>> = g.iter_arcs();
            let ghost iter_seq: Seq<LabEdge<u64, u64>> = it@.1;
            let ghost mut items: Seq<LabEdge<u64, u64>> = Seq::empty();
