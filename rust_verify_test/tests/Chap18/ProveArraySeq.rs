...
test_verify_one_file! {
    #[test] arrayseq_loop_borrow_into verus_code! {
        use vstd::prelude::*;
        use apas_verus::Chap18::ArraySeq::ArraySeq::*;

        fn test_loop_borrow_into() {
            let a: ArraySeqS<u64> = ArraySeqS::new(3, 55);

            let mut it: ArraySeqIter<u64> = (&a).into_iter();
            let ghost iter_seq: Seq<u64> = it@.1;
            let ghost mut items: Seq<u64> = Seq::empty();
...
// for-borrow-into: `for x in iter: (&a).into_iter()`
test_verify_one_file! {
    #[test] arrayseq_for_borrow_into verus_code! {
        use vstd::prelude::*;
        use apas_verus::Chap18::ArraySeq::ArraySeq::*;

        fn test_for_borrow_into() {
            let a: ArraySeqS<u64> = ArraySeqS::new(3, 77);

            let it: ArraySeqIter<u64> = (&a).into_iter();
            let ghost iter_seq: Seq<u64> = it@.1;
            let ghost mut items: Seq<u64> = Seq::empty();
...
test_verify_one_file! {
    #[test] arrayseq_loop_consume verus_code! {
        use vstd::prelude::*;
        use apas_verus::Chap18::ArraySeq::ArraySeq::*;

        fn test_loop_consume() {
            let a: ArraySeqS<u64> = ArraySeqS::new(3, 33);
...
// for-consume: `for x in iter: a.into_iter()`
test_verify_one_file! {
    #[test] arrayseq_for_consume verus_code! {
        use vstd::prelude::*;
        use apas_verus::Chap18::ArraySeq::ArraySeq::*;

        fn test_for_consume() {
            let a: ArraySeqS<u64> = ArraySeqS::new(3, 66);
            let ghost orig_seq: Seq<u64> = a.seq@;
