...
test_verify_one_file! {
    #[test] arrayseqstper_loop_borrow_into verus_code! {
        use vstd::prelude::*;
        use apas_verus::Chap18::ArraySeqStPer::ArraySeqStPer::*;
...
// for-borrow-into: `for x in iter: (&a).into_iter()`
test_verify_one_file! {
    #[test] arrayseqstper_for_borrow_into verus_code! {
        use vstd::prelude::*;
        use apas_verus::Chap18::ArraySeqStPer::ArraySeqStPer::*;
...
test_verify_one_file! {
    #[test] arrayseqstper_loop_consume verus_code! {
        use vstd::prelude::*;
        use apas_verus::Chap18::ArraySeqStPer::ArraySeqStPer::*;
...
// for-consume: `for x in iter: a.into_iter()`
test_verify_one_file! {
    #[test] arrayseqstper_for_consume verus_code! {
        use vstd::prelude::*;
        use apas_verus::Chap18::ArraySeqStPer::ArraySeqStPer::*;
