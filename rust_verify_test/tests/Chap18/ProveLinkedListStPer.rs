...
test_verify_one_file! {
    #[test] linkedliststper_loop_borrow_into verus_code! {
        use vstd::prelude::*;
        use apas_verus::Chap18::LinkedListStPer::LinkedListStPer::*;

        fn test_loop_borrow_into() {
            let list: LinkedListStPerS<u64> = LinkedListStPerS::new(3, 55);

            let mut it: LinkedListStPerIter<u64> = (&list).into_iter();
            let ghost iter_seq: Seq<u64> = it@.1;
            let ghost mut items: Seq<u64> = Seq::empty();
...
// for-borrow-into: `for x in iter: (&list).into_iter()`
test_verify_one_file! {
    #[test] linkedliststper_for_borrow_into verus_code! {
        use vstd::prelude::*;
        use apas_verus::Chap18::LinkedListStPer::LinkedListStPer::*;

        fn test_for_borrow_into() {
            let list: LinkedListStPerS<u64> = LinkedListStPerS::new(3, 77);

            let it: LinkedListStPerIter<u64> = (&list).into_iter();
            let ghost iter_seq: Seq<u64> = it@.1;
            let ghost mut items: Seq<u64> = Seq::empty();
...
test_verify_one_file! {
    #[test] linkedliststper_loop_consume verus_code! {
        use vstd::prelude::*;
        use apas_verus::Chap18::LinkedListStPer::LinkedListStPer::*;

        fn test_loop_consume() {
            let list: LinkedListStPerS<u64> = LinkedListStPerS::new(3, 33);
...
// for-consume: `for x in iter: list.into_iter()`
test_verify_one_file! {
    #[test] linkedliststper_for_consume verus_code! {
        use vstd::prelude::*;
        use apas_verus::Chap18::LinkedListStPer::LinkedListStPer::*;

        fn test_for_consume() {
            let list: LinkedListStPerS<u64> = LinkedListStPerS::new(3, 66);
            let ghost orig_seq: Seq<u64> = list.seq@;
