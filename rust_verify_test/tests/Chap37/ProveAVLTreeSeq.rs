...
//!
//! AVLTreeSeq has IntoIterator for &AVLTreeS with ensures.
//! No consuming IntoIterator for Self.
...
test_verify_one_file! {
    #[test] avltreeseq_loop_borrow_iter verus_code! {
        ...
        fn test_loop_borrow_iter() {
            ...
            let it0 = a.iter();
            let ghost orig: Seq<u64> = it0@.1;
            let mut collected: Vec<u64> = Vec::new();
            let mut it: AVLTreeSeqIter<'_, u64> = it0;
...
// r212 form C: module `AVLTreeSeq` defines no `IntoIterator for &AVLTreeS`; the pattern's `IntoIterator` impl is commented out
/*
// loop-borrow-into: Manual iteration with loop + (&a).into_iter()
test_verify_one_file! {
    #[test] avltreeseq_loop_borrow_into verus_code! {
        use vstd::prelude::*;
        use apas_verus::Chap37::AVLTreeSeq::AVLTreeSeq::*;
        ...
        fn test_loop_borrow_into() {
            ...
            let mut it: AVLTreeSeqIter<u64> = (&a).into_iter();
...
// for-borrow-into: `for x in iter: (&a).into_iter()`
test_verify_one_file! {
    #[test] avltreeseq_for_borrow_into verus_code! {
        use vstd::prelude::*;
        use apas_verus::Chap37::AVLTreeSeq::AVLTreeSeq::*;
        ...
        fn test_for_borrow_into() {
            ...
            let it: AVLTreeSeqIter<u64> = (&a).into_iter();
            let ghost iter_seq: Seq<u64> = it@.1;
            let ghost mut items: Seq<u64> = Seq::empty();
