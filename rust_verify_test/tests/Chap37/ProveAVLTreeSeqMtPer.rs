...
test_verify_one_file! {
    #[test] avltreeseqmtper_loop_borrow_iter verus_code! {
        ...
        fn test_loop_borrow_iter() {
            ...
            let mut it: AVLTreeSeqMtPerBorrowIter<'_, u64> = it0;
...
// r212 form C: module `AVLTreeSeqMtPer` defines no `IntoIterator for &AVLTreeSeqMtPerS`; the pattern's `IntoIterator` impl is commented out
/*
// loop-borrow-into
test_verify_one_file! {
