//! Proof tests for BSTPlainMtEph iterators.
//!
...
test_verify_one_file! {
    #[test] bstplainmteph_loop_borrow_iter verus_code! {
        use vstd::prelude::*;
        ...
        {
            let a: BSTPlainMtEph<u64> = BSTPlainMtEphLit![1u64, 2u64, 3u64];
...
// loop-borrow-into
// r212 form C: module `BSTPlainMtEph` defines no `IntoIterator for &BSTPlainMtEph`; the pattern's `IntoIterator` impl is commented out
// (src/experiments/intoiter_form_c_no_impl.rs), so this test is too.
/*
test_verify_one_file! {
    #[test] bstplainmteph_loop_borrow_into verus_code! {
        use vstd::prelude::*;
        use apas_verus::Chap37::BSTPlainMtEph::BSTPlainMtEph::*;
        use apas_verus::BSTPlainMtEphLit;
        use apas_verus::vstdplus::feq::feq::obeys_feq_clone;
            ...
            requires obeys_feq_clone::<u64>()
        {
            ...
            let mut it: BSTPlainMtEphIter<u64> = (&a).into_iter();
            ...
            loop
                invariant
                    ...
                    iter_invariant_bstplainmteph(&it),
                    iter_seq == it@.1,
                    it@.0 <= iter_seq.len(),
...
// for-borrow-iter
test_verify_one_file! {
    #[test] bstplainmteph_for_borrow_iter verus_code! {
        use vstd::prelude::*;
        use vstd::std_specs::iter::*;
        use apas_verus::Chap37::BSTPlainMtEph::BSTPlainMtEph::*;
        use apas_verus::BSTPlainMtEphLit;
...
/*
test_verify_one_file! {
    #[test] bstplainmteph_for_borrow_into verus_code! {
        use vstd::prelude::*;
        use apas_verus::Chap37::BSTPlainMtEph::BSTPlainMtEph::*;
        use apas_verus::BSTPlainMtEphLit;
        use apas_verus::vstdplus::feq::feq::obeys_feq_clone;
            ...
            requires obeys_feq_clone::<u64>()
        {
            ...
            let it: BSTPlainMtEphIter<u64> = (&a).into_iter();
            let ghost iter_seq: Seq<u64> = it@.1;
            let ghost mut items: Seq<u64> = Seq::empty();
