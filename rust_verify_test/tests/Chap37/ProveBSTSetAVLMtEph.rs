//! Proof tests for BSTSetAVLMtEph iterators.
//!
...
test_verify_one_file! {
    #[test] bstsetavlmteph_loop_borrow_iter verus_code! {
        use vstd::prelude::*;
        ...
        {
            let mut a: BSTSetAVLMtEph<u64> = BSTSetAVLMtEphLit![1u64, 2u64, 3u64];
...
// loop-borrow-into
// r212 form C: module `BSTSetAVLMtEph` defines no `IntoIterator for &BSTSetAVLMtEph`; the pattern's `IntoIterator` impl is commented out
// (src/experiments/intoiter_form_c_no_impl.rs), so this test is too.
/*
test_verify_one_file! {
    #[test] bstsetavlmteph_loop_borrow_into verus_code! {
        use vstd::prelude::*;
        use apas_verus::Chap37::BSTSetAVLMtEph::BSTSetAVLMtEph::*;
        use apas_verus::BSTSetAVLMtEphLit;
        use apas_verus::vstdplus::feq::feq::*;
            ...
            requires obeys_feq_clone::<u64>()
        {
            ...
            let mut it: BSTSetAVLMtEphIter<u64> = (&a).into_iter();
            ...
            loop
                invariant
                    ...
                    bstsetavlmteph_iter_invariant(&it),
                    iter_seq == it@.1,
                    it@.0 <= iter_seq.len(),
...
// for-borrow-iter
test_verify_one_file! {
    #[test] bstsetavlmteph_for_borrow_iter verus_code! {
        use vstd::prelude::*;
        use vstd::std_specs::iter::*;
        use apas_verus::Chap37::BSTSetAVLMtEph::BSTSetAVLMtEph::*;
        use apas_verus::BSTSetAVLMtEphLit;
...
/*
test_verify_one_file! {
    #[test] bstsetavlmteph_for_borrow_into verus_code! {
        use vstd::prelude::*;
        use apas_verus::Chap37::BSTSetAVLMtEph::BSTSetAVLMtEph::*;
        use apas_verus::BSTSetAVLMtEphLit;
        use apas_verus::vstdplus::feq::feq::*;
            ...
            requires obeys_feq_clone::<u64>()
        {
            ...
            let it: BSTSetAVLMtEphIter<u64> = (&a).into_iter();
            let ghost iter_seq: Seq<u64> = it@.1;
            let ghost mut items: Seq<u64> = Seq::empty();
...
// loop-consume
// r212 form C: module `BSTSetAVLMtEph` defines no consuming `IntoIterator for BSTSetAVLMtEph`; the pattern's `IntoIterator` impl is commented out
// (src/experiments/intoiter_form_c_no_impl.rs), so this test is too.
/*
test_verify_one_file! {
    #[test] bstsetavlmteph_loop_consume verus_code! {
        use vstd::prelude::*;
        use apas_verus::Chap37::BSTSetAVLMtEph::BSTSetAVLMtEph::*;
        use apas_verus::BSTSetAVLMtEphLit;
        use apas_verus::vstdplus::feq::feq::*;
...
/*
test_verify_one_file! {
    #[test] bstsetavlmteph_for_consume verus_code! {
        use vstd::prelude::*;
        use apas_verus::Chap37::BSTSetAVLMtEph::BSTSetAVLMtEph::*;
        use apas_verus::BSTSetAVLMtEphLit;
        use apas_verus::vstdplus::feq::feq::*;
