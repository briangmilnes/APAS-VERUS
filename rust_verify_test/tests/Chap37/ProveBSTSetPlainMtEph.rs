//! Proof tests for BSTSetPlainMtEph iterators.
//!
...
test_verify_one_file! {
    #[test] bstsetplainmteph_loop_borrow_iter verus_code! {
        use vstd::prelude::*;
        ...
        {
            let mut a: BSTSetPlainMtEph<u64> = BSTSetPlainMtEphLit![1u64, 2u64, 3u64];
...
// loop-borrow-into
// r212 form C: module `BSTSetPlainMtEph` defines no `IntoIterator for &BSTSetPlainMtEph`; the pattern's `IntoIterator` impl is commented out
// (src/experiments/intoiter_form_c_no_impl.rs), so this test is too.
/*
test_verify_one_file! {
    #[test] bstsetplainmteph_loop_borrow_into verus_code! {
        use vstd::prelude::*;
        use apas_verus::Chap37::BSTSetPlainMtEph::BSTSetPlainMtEph::*;
        use apas_verus::BSTSetPlainMtEphLit;
        use apas_verus::vstdplus::feq::feq::*;
            ...
            requires obeys_feq_clone::<u64>()
        {
            ...
            let mut it: BSTSetPlainMtEphIter<u64> = (&a).into_iter();
            ...
            loop
                invariant
                    ...
                    bstsetplainmteph_iter_invariant(&it),
                    iter_seq == it@.1,
                    it@.0 <= iter_seq.len(),
...
// for-borrow-iter
test_verify_one_file! {
    #[test] bstsetplainmteph_for_borrow_iter verus_code! {
        use vstd::prelude::*;
        use vstd::std_specs::iter::*;
        use apas_verus::Chap37::BSTSetPlainMtEph::BSTSetPlainMtEph::*;
        use apas_verus::BSTSetPlainMtEphLit;
...
/*
test_verify_one_file! {
    #[test] bstsetplainmteph_for_borrow_into verus_code! {
        use vstd::prelude::*;
        use apas_verus::Chap37::BSTSetPlainMtEph::BSTSetPlainMtEph::*;
        use apas_verus::BSTSetPlainMtEphLit;
        use apas_verus::vstdplus::feq::feq::*;
            ...
            requires obeys_feq_clone::<u64>()
        {
            ...
            let it: BSTSetPlainMtEphIter<u64> = (&a).into_iter();
            let ghost iter_seq: Seq<u64> = it@.1;
            let ghost mut items: Seq<u64> = Seq::empty();
...
// not BSTSetPlainMtEphIter<T>. No View or iter_invariant available on std::vec::IntoIter.
