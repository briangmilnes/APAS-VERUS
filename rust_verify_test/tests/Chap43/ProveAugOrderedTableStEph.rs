//! Proof tests for AugOrderedTableStEph iterators.
//!
...
//!
//! AugOrderedTableStEph reuses OrderedTableStEphIter from the base table.
...
test_verify_one_file! {
    #[test] chap43_augorderedtablesteph_loop_borrow_iter verus_code! {
        use vstd::prelude::*;
                ...
                view_ord_consistent::<u64>(),
        {
            ...
            let t = AugOrderedTableStEph::singleton(1u64, 10u64, reducer, 0u64);

            let mut it: OrderedTableStEphIter<u64, u64> = t.iter();
...
// loop-borrow-into
test_verify_one_file! {
    #[test] chap43_augorderedtablesteph_loop_borrow_into verus_code! {
        use vstd::prelude::*;
        use apas_verus::Types::Types::*;
        use apas_verus::Chap43::AugOrderedTableStEph::AugOrderedTableStEph::*;
        use apas_verus::Chap43::OrderedTableStEph::OrderedTableStEph::{OrderedTableStEphIter, iter_invariant, spec_pair_key_determines_order};
...
// for-borrow-iter
test_verify_one_file! {
    #[test] chap43_augorderedtablesteph_for_borrow_iter verus_code! {
        use vstd::prelude::*;
        use apas_verus::Types::Types::*;
        use apas_verus::Chap43::AugOrderedTableStEph::AugOrderedTableStEph::*;
        use apas_verus::Chap43::OrderedTableStEph::OrderedTableStEph::{OrderedTableStEphIter, iter_invariant, spec_pair_key_determines_order};
                ...
                view_ord_consistent::<u64>(),
        {
            ...
            let it: OrderedTableStEphIter<u64, u64> = t.iter();
            let ghost iter_seq: Seq<Pair<u64, u64>> = it@.1;
            let ghost mut items: Seq<Pair<u64, u64>> = Seq::empty();
...
// for-borrow-into
test_verify_one_file! {
    #[test] chap43_augorderedtablesteph_for_borrow_into verus_code! {
        use vstd::prelude::*;
        use apas_verus::Types::Types::*;
        use apas_verus::Chap43::AugOrderedTableStEph::AugOrderedTableStEph::*;
        use apas_verus::Chap43::OrderedTableStEph::OrderedTableStEph::{OrderedTableStEphIter, iter_invariant, spec_pair_key_determines_order};
