//! Proof tests for OrderedSetMtEph iterators.
//!
...
test_verify_one_file! {
    #[test] orderedsetmteph_loop_borrow_iter verus_code! {
        use vstd::prelude::*;
        ...
        fn test_loop_borrow_iter() {
            let s: OrderedSetMtEph<u64> = OrderedSetMtEphLit![1u64, 2u64, 3u64];
...
// loop-borrow-into
// r212 form C: module `OrderedSetMtEph` defines no `IntoIterator for &OrderedSetMtEph`; the pattern's `IntoIterator` impl is commented out
// (src/experiments/intoiter_form_c_no_impl.rs), so this test is too.
/*
test_verify_one_file! {
    #[test] orderedsetmteph_loop_borrow_into verus_code! {
        use vstd::prelude::*;
        use apas_verus::Chap43::OrderedSetMtEph::OrderedSetMtEph::*;
        use apas_verus::OrderedSetMtEphLit;
        ...
        fn test_loop_borrow_into() {
            ...
            let mut it: OrderedSetMtEphIter<u64> = (&s).into_iter();
            ...
            loop
                invariant
                    ...
                    iter_invariant_orderedsetmteph(&it),
                    iter_seq == it@.1,
                    it@.0 <= iter_seq.len(),
...
// for-borrow-iter
test_verify_one_file! {
    #[test] orderedsetmteph_for_borrow_iter verus_code! {
        use vstd::prelude::*;
        use vstd::std_specs::iter::*;
        use apas_verus::Chap43::OrderedSetMtEph::OrderedSetMtEph::*;
        use apas_verus::OrderedSetMtEphLit;
...
/*
test_verify_one_file! {
    #[test] orderedsetmteph_for_borrow_into verus_code! {
        use vstd::prelude::*;
        use apas_verus::Chap43::OrderedSetMtEph::OrderedSetMtEph::*;
        use apas_verus::OrderedSetMtEphLit;
        ...
        fn test_for_borrow_into() {
            ...
            let it: OrderedSetMtEphIter<u64> = (&s).into_iter();
            let ghost iter_seq: Seq<u64> = it@.1;
            let ghost mut items: Seq<u64> = Seq::empty();
