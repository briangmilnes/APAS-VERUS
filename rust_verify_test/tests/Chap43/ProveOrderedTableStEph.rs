//! Proof tests for Chap43 OrderedTableStEph iterators.
//!
...
test_verify_one_file! {
    #[test] chap43_orderedtablesteph_loop_borrow_iter verus_code! {
        use vstd::prelude::*;
        ...
        {
            let mut t = OrderedTableStEph::singleton(1u64, 10u64);
            t.insert(2u64, 20u64, |_v1: &u64, v2: &u64| -> (r: u64) { *v2 });
            t.insert(3u64, 30u64, |_v1: &u64, v2: &u64| -> (r: u64) { *v2 });
...
// loop-borrow-into
// r212 form C: module `OrderedTableStEph` defines no `IntoIterator for &OrderedTableStEph`; the pattern's `IntoIterator` impl is commented out
// (src/experiments/intoiter_form_c_no_impl.rs), so this test is too.
/*
test_verify_one_file! {
    #[test] chap43_orderedtablesteph_loop_borrow_into verus_code! {
        use vstd::prelude::*;
        use vstd::std_specs::iter::*;
        use apas_verus::Types::Types::*;
        use apas_verus::Chap43::OrderedTableStEph::OrderedTableStEph::*;
                ...
                view_ord_consistent::<u64>(),
        {
            ...
            let mut it: OrderedTableStEphIter<u64, u64> = (&t).into_iter();
...
// for-borrow-iter
test_verify_one_file! {
    #[test] chap43_orderedtablesteph_for_borrow_iter verus_code! {
        use vstd::prelude::*;
        use vstd::std_specs::iter::*;
        use apas_verus::Types::Types::*;
        use apas_verus::Chap43::OrderedTableStEph::OrderedTableStEph::*;
...
/*
test_verify_one_file! {
    #[test] chap43_orderedtablesteph_for_borrow_into verus_code! {
        use vstd::prelude::*;
        use vstd::std_specs::iter::*;
        use apas_verus::Types::Types::*;
        use apas_verus::Chap43::OrderedTableStEph::OrderedTableStEph::*;
                ...
                view_ord_consistent::<u64>(),
        {
            ...
            let it: OrderedTableStEphIter<u64, u64> = (&t).into_iter();
            let ghost iter_seq: Seq<Pair<u64, u64>> = it@.1;
            let ghost mut items: Seq<Pair<u64, u64>> = Seq::empty();
