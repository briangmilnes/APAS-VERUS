//! Proof tests for standards::mod_standard iterators (delegated iteration
//! under the verus 0.2026.09.13 prophetic iterator model).
//!
...
test_verify_one_file! {
    #[test] mod_standard_loop_borrow_iter verus_code! {
        use vstd::prelude::*;
...
// loop-borrow-into
test_verify_one_file! {
    #[test] mod_standard_loop_borrow_into verus_code! {
        use vstd::prelude::*;
        use vstd::std_specs::iter::*;
        use apas_verus::standards::mod_standard::mod_standard::*;
...
// loop-consume
test_verify_one_file! {
    #[test] mod_standard_loop_consume verus_code! {
        use vstd::prelude::*;
        use vstd::std_specs::iter::*;
        use apas_verus::standards::mod_standard::mod_standard::*;
...
// for-borrow-iter
test_verify_one_file! {
    #[test] mod_standard_for_borrow_iter verus_code! {
        use vstd::prelude::*;
        use vstd::std_specs::iter::*;
        use apas_verus::standards::mod_standard::mod_standard::*;
...
// for-borrow-into
test_verify_one_file! {
    #[test] mod_standard_for_borrow_into verus_code! {
        use vstd::prelude::*;
        use vstd::std_specs::iter::*;
        use apas_verus::standards::mod_standard::mod_standard::*;
...
// for-consume
test_verify_one_file! {
    #[test] mod_standard_for_consume verus_code! {
        use vstd::prelude::*;
        use vstd::std_specs::iter::*;
        use apas_verus::standards::mod_standard::mod_standard::*;
