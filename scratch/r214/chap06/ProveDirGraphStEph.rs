//! Proof tests for DirGraphStEph iterators (prophetic model, r214)
//!
...
//!   - for-borrow-iter  (vertices): `for x in it: g.iter_vertices()`
//!   - for-borrow-iter  (arcs):     `for x in it: g.iter_arcs()`
//!
