...
test_verify_one_file! {
    #[test] undirgraphmteph_loop_borrow_iter_vertices verus_code! {
        use vstd::prelude::*;
            ...
            requires valid_key_type_for_graph::<u64>()
        {
            ...
            let g: UnDirGraphMtEph<u64> = UnDirGraphMtEph::from_sets(verts, edges);
...
test_verify_one_file! {
    #[test] undirgraphmteph_loop_borrow_iter_edges verus_code! {
        use vstd::prelude::*;
        use vstd::std_specs::iter::*;
        use vstd::std_specs::hash::into_iter_hash_keys;
        use apas_verus::Types::Types::*;
...
test_verify_one_file! {
    #[test] undirgraphmteph_for_borrow_iter_vertices verus_code! {
        use vstd::prelude::*;
        use vstd::std_specs::iter::*;
        use vstd::std_specs::hash::into_iter_hash_keys;
        use apas_verus::Types::Types::*;
...
test_verify_one_file! {
    #[test] undirgraphmteph_for_borrow_iter_edges verus_code! {
        use vstd::prelude::*;
        use vstd::std_specs::iter::*;
        use vstd::std_specs::hash::into_iter_hash_keys;
        use apas_verus::Types::Types::*;
