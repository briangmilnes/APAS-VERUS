//! Proof tests for WeightedDirGraphStEphI32 iterators (prophetic model, r214)
//!
...
test_verify_one_file! {
    #[test] weighteddirgraphstephi32_loop_borrow_iter_arcs verus_code! {
            ...
            requires valid_key_type_LabEdge::<u64, i32>()
        {
            ...
            let ghost orig: Seq<LabEdge<u64, i32>> = into_iter_hash_keys(it0);
            let mut collected: Vec<LabEdge<u64, i32>> = Vec::new();
            let mut it = it0;
            let ghost mut pos: int = 0;
            loop
                invariant
