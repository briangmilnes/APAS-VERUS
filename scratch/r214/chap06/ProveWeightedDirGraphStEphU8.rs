//! Proof tests for WeightedDirGraphStEphU8 iterators (prophetic model, r214)
//!
...
test_verify_one_file! {
    #[test] weighteddirgraphstephu8_loop_borrow_iter_arcs verus_code! {
            ...
            requires valid_key_type_LabEdge::<u64, u8>()
        {
            ...
            let ghost orig: Seq<LabEdge<u64, u8>> = into_iter_hash_keys(it0);
            let mut collected: Vec<LabEdge<u64, u8>> = Vec::new();
            let mut it = it0;
            let ghost mut pos: int = 0;
            loop
                invariant
