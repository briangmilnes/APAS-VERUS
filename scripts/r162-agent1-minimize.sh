#!/usr/bin/env bash
# R162 Agent1 sequential veracity-minimize-lib loop.
#
# Chapters (odd positions from sorted remaining list):
#   57 51 65 62 43
#
# Estimated runtime: ~458 min (~7.6 hours sequential).

set -uo pipefail

AGENT="/home/milnes/projects/APAS-VERUS-agent1"
VERACITY="/home/milnes/projects/veracity/target/release/veracity-minimize-lib"
VERACITY_DIR="/home/milnes/projects/veracity"

CHAPTERS=(57 51 65 62 43)
...
R162 Agent 1: minimize Chap${CHAP} (-${REMOVED} asserts)
