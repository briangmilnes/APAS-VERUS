#!/usr/bin/env bash
# R162 Agent2 sequential veracity-minimize-lib loop.
#
# Chapters (even positions from sorted remaining list):
#   59 53 47 45
#
# Estimated runtime: ~286 min (~4.8 hours sequential).

set -uo pipefail

AGENT="/home/milnes/projects/APAS-VERUS-agent2"
VERACITY="/home/milnes/projects/veracity/target/release/veracity-minimize-lib"
VERACITY_DIR="/home/milnes/projects/veracity"

CHAPTERS=(59 53 47 45)
...
R162 Agent 2: minimize Chap${CHAP} (-${REMOVED} asserts)
