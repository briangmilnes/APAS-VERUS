#!/usr/bin/env bash
# R162 Agent5 sequential veracity-minimize-lib loop.
#
# Chapters: 41 52 44 49 50
#
# Estimated runtime: ~25.8 hours sequential.

set -uo pipefail

AGENT="/home/milnes/projects/APAS-VERUS-agent5"
...
R162 Agent 5: minimize Chap${CHAP} (-${REMOVED} asserts)
