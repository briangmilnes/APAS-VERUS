#!/usr/bin/env bash
# R162 Agent6 sequential veracity-minimize-lib loop.
#
# Chapters: 38 39 42 55
#
# Estimated runtime: ~25.2 hours sequential.

set -uo pipefail

AGENT="/home/milnes/projects/APAS-VERUS-agent6"
...
R162 Agent 6: minimize Chap${CHAP} (-${REMOVED} asserts)
