...
//! Chapter 6 Weighed Directed Graph (ephemeral) with integer weights - Single-threaded version.
...
verus! {
    ...
    pub type WeighedDirGraphStEphInt<V> = LabDirGraphStEph<V, i32>;

    pub trait WeighedDirGraphStEphIntTrait<V: StT + Hash>: 
        ...
        fn from_weighed_edges(vertices: SetStEph<V>, edges: SetStEph<Triple<V, V, i32>>) -> (g: WeighedDirGraphStEphInt<V>)
        ...
        fn edges_above_weight(&self, threshold: i32) -> (edges_above: SetStEph<Triple<V, V, i32>>)
            requires valid_key_type_WeighedEdge::<V, i32>()
            ensures 
                forall |t: (V::V, V::V, i32)| #[trigger] edges_above@.contains(t) == 
                    (self@.A.contains(t) && t.2 > threshold);

        fn edges_below_weight(&self, threshold: i32) -> (edges_below: SetStEph<Triple<V, V, i32>>)
            requires valid_key_type_WeighedEdge::<V, i32>()
            ensures 
    ...
    impl<V: StT + Hash> WeighedDirGraphStEphIntTrait<V> for WeighedDirGraphStEphInt<V> {
    ...
    #[macro_export]
    macro_rules! WeighedDirGraphStEphIntLit {
        () => {{
        ...
        ( V: [ $( $v:expr ),* $(,)? ], E: [ $( $edge:expr ),* $(,)? ] ) => {{
            ...
            <$crate::Chap06::WeighedDirGraphStEphInt::WeighedDirGraphStEphInt::WeighedDirGraphStEphInt<_> as $crate::Chap06::WeighedDirGraphStEphInt::WeighedDirGraphStEphInt::WeighedDirGraphStEphIntTrait<_>>::from_weighed_edges(vertices, edges)
        }};
    }
}
