...
//! Chapter 6 Weighted Directed Graph (ephemeral) with i64 weights - Single-threaded version.
//! Uses CheckedI64 for overflow-safe weight summation.
...
verus! {
    ...
    pub type WeightedDirGraphStEphI64<V> = LabDirGraphStEph<V, i64>;

    pub trait WeightedDirGraphStEphI64Trait<V: StT + Hash>: 
        View<V = LabGraphView<<V as View>::V, i64>> + Sized {

        open spec fn spec_total_weight(&self) -> int 
         { self@.A.fold(0int, |acc: int, t: (V::V, V::V, i64)| acc + t.2 as int) }

        /// - APAS: Work Θ(|V| + |E|), Span Θ(1)
        /// - Claude-Opus-4.6: Work Θ(|V| + |E|), Span Θ(|V| + |E|) -- sequential
        fn from_weighed_edges(vertices: SetStEph<V>, edges: SetStEph<WeightedEdge<V, i64>>) -> (g: WeightedDirGraphStEphI64<V>)
            requires
        ...
        fn add_weighed_edge(&mut self, from: V, to: V, weight: i64)
        ...
        fn get_edge_weight(&self, from: &V, to: &V) -> (weight: Option<i64>)
            requires spec_labgraphview_wf(self@), valid_key_type_WeightedEdge::<V, i64>()
            ensures
        ...
        fn weighed_edges(&self) -> (weighed_edges: SetStEph<WeightedEdge<V, i64>>)
            requires spec_labgraphview_wf(self@), valid_key_type_WeightedEdge::<V, i64>()
            ensures
        ...
        fn out_neighbors_weighed(&self, v: &V) -> (out_neighbors: SetStEph<Pair<V, i64>>)
            requires spec_labgraphview_wf(self@), valid_key_type_WeightedEdge::<V, i64>()
            ensures
        ...
        /// - APAS: Work Θ(|A|), Span Θ(1)
        /// - Claude-Opus-4.6: Work Θ(|A|), Span Θ(|A|) -- sequential filter
        fn in_neighbors_weighed(&self, v: &V) -> (in_neighbors: SetStEph<Pair<V, i64>>)
            requires spec_labgraphview_wf(self@), valid_key_type_WeightedEdge::<V, i64>()
            ensures
        ...
        fn total_weight(&self) -> (total_weight: CheckedI64)
            requires spec_labgraphview_wf(self@), valid_key_type_WeightedEdge::<V, i64>()
            ensures total_weight@ == self.spec_total_weight();

        /// - APAS: Work Θ(|A|), Span Θ(1)
        /// - Claude-Opus-4.6: Work Θ(|A|), Span Θ(|A|) -- sequential filter
        fn edges_above_weight(&self, threshold: i64) -> (edges_above: SetStEph<WeightedEdge<V, i64>>)
            requires spec_labgraphview_wf(self@), valid_key_type_WeightedEdge::<V, i64>()
            ensures
        ...
        /// - APAS: Work Θ(|A|), Span Θ(1)
        /// - Claude-Opus-4.6: Work Θ(|A|), Span Θ(|A|) -- sequential filter
        fn edges_below_weight(&self, threshold: i64) -> (edges_below: SetStEph<WeightedEdge<V, i64>>)
            requires spec_labgraphview_wf(self@), valid_key_type_WeightedEdge::<V, i64>()
            ensures
    ...
    impl<V: StT + Hash> WeightedDirGraphStEphI64Trait<V> for WeightedDirGraphStEphI64<V> {

        /// APAS: Work Θ(|V| + |E|), Span Θ(1)
        fn from_weighed_edges(vertices: SetStEph<V>, edges: SetStEph<WeightedEdge<V, i64>>) -> (g: WeightedDirGraphStEphI64<V>) {
            let mut edge_set: SetStEph<LabEdge<V, i64>> = SetStEph::empty();
        ...
        /// APAS: Work Θ(|A|), Span Θ(1)
        fn weighed_edges(&self) -> (weighed_edges: SetStEph<WeightedEdge<V, i64>>) {
            let mut edges: SetStEph<WeightedEdge<V, i64>> = SetStEph::empty();
...
assert forall |t: (V::V, V::V, i64)| #[trigger] wa_view.contains(t) implies edges@.contains(t) by {
        ...
        /// APAS: Work Θ(|A|), Span Θ(1)
        fn out_neighbors_weighed(&self, v: &V) -> (out_neighbors: SetStEph<Pair<V, i64>>) {
            let mut neighbors: SetStEph<Pair<V, i64>> = SetStEph::empty();
            let mut it = self.labeled_arcs().iter();
            let ghost wa_seq = it@.1;
            let ghost v_view = v@;
            let ghost wa_view = self@.A;
        ...
        fn total_weight(&self) -> (total_weight: CheckedI64) { 
            ...
            loop
                invariant
                    ...
                    wa_seq.map(|i: int, e: LabEdge<V, i64>| e@).to_set() == wa_view,
                    sum@ == wa_seq.take(it@.0 as int).fold_left(0int, |acc: int, e: LabEdge<V, i64>| acc + e@.2 as int),
                decreases wa_seq.len() - it@.0,
            {
                match it.next() {
                    None => {
                        proof {
                            lemma_reveal_view_injective::<LabEdge<V, i64>>();
                            lemma_signed_seq_fold_left_plus_is_weighted_seq_sum_i64::<LabEdge<V, i64>, V::V, V::V>(wa_seq);
                            lemma_signed_weighted_seq_fold_equals_set_fold_i64(wa_seq.map(|_i: int, e: LabEdge<V, i64>| e@));
                        }
                        return sum;
                    },
                    Some(labeled_edge) => {
...
assert forall |t: (V::V, V::V, i64)| #[trigger] wa_view.contains(t) && t.2 < threshold implies 
    ...
    #[macro_export]
    macro_rules! WeightedDirGraphStEphI64Lit {
        () => {{
        ...
        ( V: [ $( $v:expr ),* $(,)? ], E: [ $( $edge:expr ),* $(,)? ] ) => {{
            ...
            <$crate::Chap06::WeightedDirGraphStEphI64::WeightedDirGraphStEphI64::WeightedDirGraphStEphI64<_> as $crate::Chap06::WeightedDirGraphStEphI64::WeightedDirGraphStEphI64::WeightedDirGraphStEphI64Trait<_>>::from_weighed_edges(vertices, edges)
        }};
    }
}
