...
pub mod WeightedDirGraphStEphI8 {
    ...
    use crate::vstdplus::checked_int::checked_int::CheckedI8;
        ...
        fn weighed_edges(&self) -> (weighed_edges: SetStEph<WeightedEdge<V, i8>>) {
                ...
                decreases wa_seq.len() - it@.0,
            {
                match it.next() {
                    None => {
                        proof {
// Veracity: UNNEEDED assert                             assert forall |t: (V::V, V::V, i8)| #[trigger] edges@.contains(t) implies wa_view.contains(t) by {
                                if edges@.contains(t) {
...
// Veracity: UNNEEDED assert                             assert forall |t: (V::V, V::V, i8)| #[trigger] wa_view.contains(t) implies edges@.contains(t) by {
        ...
        fn out_neighbors_weighed(&self, v: &V) -> (out_neighbors: SetStEph<Pair<V, i8>>) {
                ...
                decreases wa_seq.len() - it@.0,
            {
                match it.next() {
                    None => {
                        proof {
// Veracity: UNNEEDED assert                             assert forall |p: (V::V, i8)| neighbors@.contains(p) implies 
...
// Veracity: UNNEEDED assert                             assert forall |p: (V::V, i8)| (exists |w: i8| #![trigger wa_view.contains((v_view, p.0, w))] wa_view.contains((v_view, p.0, w)) && p.1 == w) implies 
...
// Veracity: UNNEEDED assert                             assert forall |p: (V::V, i8)| (exists |w: i8| #![trigger wa_view.contains((p.0, v_view, w))] wa_view.contains((p.0, v_view, w)) && p.1 == w) implies 
                                neighbors@.contains(p) by {
        ...
        fn edges_above_weight(&self, threshold: i8) -> (edges_above: SetStEph<WeightedEdge<V, i8>>) {
                ...
                decreases wa_seq.len() - it@.0,
            {
                match it.next() {
                    None => {
                        proof {
// Veracity: UNNEEDED assert                             assert forall |t: (V::V, V::V, i8)| #[trigger] edges@.contains(t) implies 
...
// Veracity: UNNEEDED assert                             assert forall |t: (V::V, V::V, i8)| #[trigger] wa_view.contains(t) && t.2 > threshold implies 
                                edges@.contains(t) by {
