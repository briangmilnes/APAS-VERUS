...
pub mod WeightedDirGraphStEphU8 {
    ...
    use crate::vstdplus::checked_nat::checked_nat::CheckedU8;
...
verus! {
    ...
    pub type WeightedDirGraphStEphU8<V> = LabDirGraphStEph<V, u8>;

    pub trait WeightedDirGraphStEphU8Trait<V: StT + Hash>: 
        View<V = LabGraphView<<V as View>::V, u8>> + Sized {

        open spec fn spec_total_weight(&self) -> nat 
         { self@.A.fold(0nat, |acc: nat, t: (V::V, V::V, u8)| acc + t.2 as nat) }

        /// APAS: Work Θ(|V| + |E|), Span Θ(1)
        fn from_weighed_edges(vertices: SetStEph<V>, edges: SetStEph<WeightedEdge<V, u8>>) -> (g: WeightedDirGraphStEphU8<V>)
            requires valid_key_type_WeightedEdge::<V, u8>()
            ensures g@.V.finite(), g@.A.finite();

        /// APAS: Work Θ(1), Span Θ(1)
        fn add_weighed_edge(&mut self, from: V, to: V, weight: u8)
            requires valid_key_type_WeightedEdge::<V, u8>()
            ensures 
        ...
        fn get_edge_weight(&self, from: &V, to: &V) -> (weight: Option<u8>)
            requires valid_key_type_WeightedEdge::<V, u8>()
            ensures 
        ...
        /// APAS: Work Θ(|A|), Span Θ(1)
        fn weighed_edges(&self) -> (weighed_edges: SetStEph<WeightedEdge<V, u8>>)
            requires valid_key_type_WeightedEdge::<V, u8>()
            ensures 
                forall |t: (V::V, V::V, u8)| #[trigger] weighed_edges@.contains(t) == self@.A.contains(t);

        /// APAS: Work Θ(|A|), Span Θ(1)
        fn out_neighbors_weighed(&self, v: &V) -> (out_neighbors: SetStEph<Pair<V, u8>>)
            requires valid_key_type_WeightedEdge::<V, u8>()
            ensures 
        ...
        /// APAS: Work Θ(|A|), Span Θ(1)
        fn in_neighbors_weighed(&self, v: &V) -> (in_neighbors: SetStEph<Pair<V, u8>>)
            requires valid_key_type_WeightedEdge::<V, u8>()
            ensures 
        ...
        /// APAS: Work Θ(|A|), Span Θ(1)
        fn total_weight(&self) -> (total_weight: CheckedU8)
            requires valid_key_type_WeightedEdge::<V, u8>()
            ensures total_weight@ == self.spec_total_weight() as int;

        fn edges_above_weight(&self, threshold: u8) -> (edges_above: SetStEph<WeightedEdge<V, u8>>)
            requires valid_key_type_WeightedEdge::<V, u8>()
            ensures 
                forall |t: (V::V, V::V, u8)| #[trigger] edges_above@.contains(t) == 
                    (self@.A.contains(t) && t.2 > threshold);

        fn edges_below_weight(&self, threshold: u8) -> (edges_below: SetStEph<WeightedEdge<V, u8>>)
            requires valid_key_type_WeightedEdge::<V, u8>()
            ensures 
    ...
    impl<V: StT + Hash> WeightedDirGraphStEphU8Trait<V> for WeightedDirGraphStEphU8<V> {

        /// APAS: Work Θ(|V| + |E|), Span Θ(1)
        fn from_weighed_edges(vertices: SetStEph<V>, edges: SetStEph<WeightedEdge<V, u8>>) -> (g: WeightedDirGraphStEphU8<V>) {
            let mut edge_set: SetStEph<LabEdge<V, u8>> = SetStEph::empty();
        ...
        /// APAS: Work Θ(|A|), Span Θ(1)
        fn weighed_edges(&self) -> (weighed_edges: SetStEph<WeightedEdge<V, u8>>) {
            let mut edges: SetStEph<WeightedEdge<V, u8>> = SetStEph::empty();
            ...
            loop
                invariant
                    ...
                    it@.0 <= wa_seq.len(),
                    it@.1 == wa_seq,
                    wa_seq.map(|i: int, e: LabEdge<V, u8>| e@).to_set() == wa_view,
                    forall |t: (V::V, V::V, u8)| edges@.contains(t) == 
                ...
                decreases wa_seq.len() - it@.0,
            {
                match it.next() {
                    None => {
                        proof {
// Veracity: UNNEEDED assert                             assert forall |t: (V::V, V::V, u8)| #[trigger] edges@.contains(t) implies wa_view.contains(t) by {
                                if edges@.contains(t) {
...
// Veracity: UNNEEDED assert                             assert forall |t: (V::V, V::V, u8)| #[trigger] wa_view.contains(t) implies edges@.contains(t) by {
        ...
        /// APAS: Work Θ(|A|), Span Θ(1)
        fn out_neighbors_weighed(&self, v: &V) -> (out_neighbors: SetStEph<Pair<V, u8>>) {
            let mut neighbors: SetStEph<Pair<V, u8>> = SetStEph::empty();
            let mut it = self.labeled_arcs().iter();
            let ghost wa_seq = it@.1;
            let ghost v_view = v@;
            let ghost wa_view = self@.A;
            ...
            loop
                invariant
                    ...
                    it@.1 == wa_seq,
                    wa_seq.map(|i: int, e: LabEdge<V, u8>| e@).to_set() == wa_view,
                    forall |p: (V::V, u8)| neighbors@.contains(p) == 
                ...
                decreases wa_seq.len() - it@.0,
            {
                match it.next() {
                    None => {
                        proof {
// Veracity: UNNEEDED assert                             assert forall |p: (V::V, u8)| neighbors@.contains(p) implies 
                                (exists |w: u8| #![trigger wa_view.contains((v_view, p.0, w))] wa_view.contains((v_view, p.0, w)) && p.1 == w) by {
                                if neighbors@.contains(p) {
                                    let i = choose |i: int| #![trigger wa_seq[i]] 0 <= i < wa_seq.len() && wa_seq[i]@.0 == v_view && wa_seq[i]@.1 == p.0 && wa_seq[i]@.2 == p.1;
                                    crate::vstdplus::seq_set::lemma_seq_index_in_map_to_set(wa_seq, i);
                                }
                            }
// Veracity: UNNEEDED assert                             assert forall |p: (V::V, u8)| (exists |w: u8| #![trigger wa_view.contains((v_view, p.0, w))] wa_view.contains((v_view, p.0, w)) && p.1 == w) implies 
                                neighbors@.contains(p) by {
                                if exists |w: u8| #![trigger wa_view.contains((v_view, p.0, w))] wa_view.contains((v_view, p.0, w)) && p.1 == w {
                                    let w = choose |w: u8| #![trigger wa_view.contains((v_view, p.0, w))] wa_view.contains((v_view, p.0, w)) && p.1 == w;
                ...
                decreases wa_seq.len() - it@.0,
            {
                match it.next() {
                    None => {
                        proof {
// Veracity: UNNEEDED assert                             assert forall |p: (V::V, u8)| neighbors@.contains(p) implies 
                                (exists |w: u8| #![trigger wa_view.contains((p.0, v_view, w))] wa_view.contains((p.0, v_view, w)) && p.1 == w) by {
                                if neighbors@.contains(p) {
                                    let i = choose |i: int| #![trigger wa_seq[i]] 0 <= i < wa_seq.len() && wa_seq[i]@.1 == v_view && wa_seq[i]@.0 == p.0 && wa_seq[i]@.2 == p.1;
                                    crate::vstdplus::seq_set::lemma_seq_index_in_map_to_set(wa_seq, i);
                                }
                            }
// Veracity: UNNEEDED assert                             assert forall |p: (V::V, u8)| (exists |w: u8| #![trigger wa_view.contains((p.0, v_view, w))] wa_view.contains((p.0, v_view, w)) && p.1 == w) implies 
                                neighbors@.contains(p) by {
                                if exists |w: u8| #![trigger wa_view.contains((p.0, v_view, w))] wa_view.contains((p.0, v_view, w)) && p.1 == w {
                                    let w = choose |w: u8| #![trigger wa_view.contains((p.0, v_view, w))] wa_view.contains((p.0, v_view, w)) && p.1 == w;
        ...
        fn total_weight(&self) -> (total_weight: CheckedU8) { 
            ...
            loop
                invariant
                    ...
                    wa_seq.map(|i: int, e: LabEdge<V, u8>| e@).to_set() == wa_view,
                    sum@ == wa_seq.take(it@.0 as int).fold_left(0int, |acc: int, e: LabEdge<V, u8>| acc + e@.2 as nat),
                decreases wa_seq.len() - it@.0,
            {
                match it.next() {
                    None => {
                        proof {
                            lemma_seq_fold_left_plus_is_weighted_seq_sum_u8::<LabEdge<V, u8>, V::V, V::V>(wa_seq);
                            lemma_fold_left_int_equals_nat_as_int_u8::<LabEdge<V, u8>, V::V, V::V>(wa_seq);
                            lemma_weighted_seq_fold_equals_set_fold_u8(wa_seq.map(|_i: int, e: LabEdge<V, u8>| e@));
                        }
                        return sum;
                    },
                    Some(labeled_edge) => {
        ...
        fn edges_above_weight(&self, threshold: u8) -> (edges_above: SetStEph<WeightedEdge<V, u8>>) {
                ...
                decreases wa_seq.len() - it@.0,
            {
                match it.next() {
                    None => {
                        proof {
// Veracity: UNNEEDED assert                             assert forall |t: (V::V, V::V, u8)| #[trigger] edges@.contains(t) implies 
...
// Veracity: UNNEEDED assert                             assert forall |t: (V::V, V::V, u8)| #[trigger] wa_view.contains(t) && t.2 > threshold implies 
                                edges@.contains(t) by {
...
// Veracity: UNNEEDED assert                             assert forall |t: (V::V, V::V, u8)| #[trigger] wa_view.contains(t) && t.2 < threshold implies 
    ...
    #[macro_export]
    macro_rules! WeightedDirGraphStEphU8Lit {
        () => {{
        ...
        ( V: [ $( $v:expr ),* $(,)? ], E: [ $( $edge:expr ),* $(,)? ] ) => {{
            ...
            <$crate::Chap06::WeightedDirGraphStEphU8::WeightedDirGraphStEphU8::WeightedDirGraphStEphU8<_> as $crate::Chap06::WeightedDirGraphStEphU8::WeightedDirGraphStEphU8::WeightedDirGraphStEphU8Trait<_>>::from_weighed_edges(vertices, edges)
        }};
    }
}
