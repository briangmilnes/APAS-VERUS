...
pub mod QuickSortStEph {
    ...
    fn qsort_base_case<T: TotalOrder + Copy>(a: &ArraySeqStEphS<T>) -> (sorted: Vec<T>)
    ...
    /// Quicksort with first-element pivot. Self-recursive at every level.
    fn qsort_first<T: TotalOrder + Copy>(a: &ArraySeqStEphS<T>) -> (sorted: Vec<T>)
        ...
        decreases a.spec_len(),
    {
        ...
        let sorted_left_a = ArraySeqStEphS { seq: qsort_first(&left_a) };
        let sorted_right_a = ArraySeqStEphS { seq: qsort_first(&right_a) };
    ...
    /// Quicksort with median-of-three pivot. Self-recursive at every level.
    fn qsort_median3<T: TotalOrder + Copy>(a: &ArraySeqStEphS<T>) -> (sorted: Vec<T>)
        requires a.spec_len() <= usize::MAX,
        ensures sorted@ =~= a.seq@.sort_by(spec_leq::<T>())
        decreases a.spec_len(),
    {
        ...
        let right_a = ArraySeqStEphS { seq: right };
        let equals_a = ArraySeqStEphS { seq: equals };
        let sorted_left_a = ArraySeqStEphS { seq: qsort_median3(&left_a) };
        let sorted_right_a = ArraySeqStEphS { seq: qsort_median3(&right_a) };
    ...
    /// Quicksort with random pivot. Self-recursive at every level.
    fn qsort_random<T: TotalOrder + Copy>(a: &ArraySeqStEphS<T>) -> (sorted: Vec<T>)
        requires a.spec_len() <= usize::MAX,
        ensures sorted@ =~= a.seq@.sort_by(spec_leq::<T>())
        decreases a.spec_len(),
    {
        ...
        let right_a = ArraySeqStEphS { seq: right };
        let equals_a = ArraySeqStEphS { seq: equals };
        let sorted_left_a = ArraySeqStEphS { seq: qsort_random(&left_a) };
        let sorted_right_a = ArraySeqStEphS { seq: qsort_random(&right_a) };
