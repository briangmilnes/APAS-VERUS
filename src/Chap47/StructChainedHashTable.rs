...
pub mod StructChainedHashTable {
    ...
    // 9. impls (inside verus!: ChainListTrait for ChainList, PartialEqSpecImpl, Default, chain helpers, EntryTrait for ChainList; outside verus!: ParaHashTableStEphTrait, ChainedHashTable)
