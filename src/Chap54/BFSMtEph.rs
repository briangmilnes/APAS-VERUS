...
//! Breadth-First Search - Parallel Ephemeral (Chapter 54, Algorithms 54.3 and 54.6).
...
pub mod BFSMtEph {
    ...
    pub open spec fn spec_wf_graph(graph: &ArraySeqMtEphS<ArraySeqMtEphS<N>>) -> bool {
    ...
    fn copy_distances(distances: &ArraySeqMtEphS<N>) -> (result: ArraySeqMtEphS<N>)
    ...
    fn copy_graph(graph: &ArraySeqMtEphS<ArraySeqMtEphS<N>>) -> (result: ArraySeqMtEphS<ArraySeqMtEphS<N>>)
    ...
    pub trait BFSMtEphTrait {
        fn bfs(graph: &ArraySeqMtEphS<ArraySeqMtEphS<N>>, source: N) -> (result: ArraySeqMtEphS<N>)
            requires
        ...
        fn bfs_tree(graph: &ArraySeqMtEphS<ArraySeqMtEphS<N>>, source: N) -> (result: BFSTreeS)
            requires
                source < graph.spec_len(),
                graph.spec_len() > 0,
                graph.spec_len() < usize::MAX,
    ...
    pub fn bfs(graph: &ArraySeqMtEphS<ArraySeqMtEphS<N>>, source: N) -> (result: ArraySeqMtEphS<N>)
        requires
            source < graph.spec_len(),
            graph.spec_len() > 0,
            graph.spec_len() < usize::MAX,
    ...
    #[verifier::exec_allows_no_decreases_clause]
    pub fn bfs_tree(graph: &ArraySeqMtEphS<ArraySeqMtEphS<N>>, source: N) -> (result: BFSTreeS)
        requires
            source < graph.spec_len(),
            graph.spec_len() > 0,
            graph.spec_len() < usize::MAX,
    ...
    impl BFSTreeS {
        ...
        pub fn top_down_order(&self) -> (result: &ArraySeqMtEphS<N>)
            ensures
        ...
        pub fn bottom_up_order(&self) -> (result: ArraySeqMtEphS<N>)
