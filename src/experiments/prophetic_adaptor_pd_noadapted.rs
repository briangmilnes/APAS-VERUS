...
//! Experiment (r207, agent 3 probe): pa_nointoiter minus iter_adapted in OuterTrait. Is the trait method iter_adapted the cause of the next() failure?
//!
//! RESULT: SUCCEEDS — 6 verified, 0 errors
//! DATE: 2026-09-20
//! VERUS: 0.2026.09.13.671956e
//! LOG: logs/validate-standard-exp_adaptor_pd_noadapted.20260920-154840.log
//! LOG: logs/validate-experiment-prophetic_adaptor_pd_noadapted.20260920-160417.log (re-run from this path)
//! Context: docs/StandardsUpgrade.md section 2.3; the wrapping (adaptor) iterator standard.

pub mod prophetic_adaptor_pd_noadapted {
