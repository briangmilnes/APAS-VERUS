    ...
    decreases seq.len(),
{
    ...
    if seq.len() == 0 {
        ...
        vstd::iset::fold::lemma_fold_empty::<nat, nat>(0nat, f);
    } else {
        ...
        vstd::iset::fold::lemma_fold_insert(prefix.to_set().to_iset(),0nat, f, last);
    }
}
    ...
    decreases seq.len(),
{
    ...
    if seq.len() == 0 {
        assert(seq.to_set() =~= Set::empty());
        vstd::iset::fold::lemma_fold_empty::<(A, B, u32), nat>(0nat, f);
    } else {
        let n = (seq.len() - 1) as int;
        let prefix = seq.take(n);
        let last = seq[n];
    ...
    decreases seq.len(),
{
    ...
    if seq.len() == 0 {
        assert(seq.to_set() =~= Set::empty());
        vstd::iset::fold::lemma_fold_empty::<(A, B, u8), nat>(0nat, f);
    } else {
        let n = (seq.len() - 1) as int;
        let prefix = seq.take(n);
        let last = seq[n];
    ...
    decreases seq.len(),
{
    ...
    if seq.len() == 0 {
        assert(seq.to_set() =~= Set::empty());
        vstd::iset::fold::lemma_fold_empty::<(A, B, u16), nat>(0nat, f);
    } else {
        let n = (seq.len() - 1) as int;
        let prefix = seq.take(n);
        let last = seq[n];
    ...
    decreases seq.len(),
{
    ...
    if seq.len() == 0 {
        assert(seq.to_set() =~= Set::empty());
        vstd::iset::fold::lemma_fold_empty::<(A, B, u64), nat>(0nat, f);
    } else {
        let n = (seq.len() - 1) as int;
        let prefix = seq.take(n);
        let last = seq[n];
    ...
    decreases seq.len(),
{
    ...
    if seq.len() == 0 {
        assert(seq.to_set() =~= Set::empty());
        vstd::iset::fold::lemma_fold_empty::<(A, B, u128), nat>(0nat, f);
    } else {
        let n = (seq.len() - 1) as int;
        let prefix = seq.take(n);
        let last = seq[n];
    ...
    decreases seq.len(),
{
    ...
    if seq.len() == 0 {
        assert(seq.to_set() =~= Set::empty());
        vstd::iset::fold::lemma_fold_empty::<(A, B, usize), nat>(0nat, f);
    } else {
        let n = (seq.len() - 1) as int;
        let prefix = seq.take(n);
        let last = seq[n];
    ...
    decreases seq.len(),
{
    ...
    if seq.len() == 0 {
        assert(seq.to_set() =~= Set::empty());
        vstd::iset::fold::lemma_fold_empty::<(A, B, i8), int>(0int, f);
    } else {
        let n = (seq.len() - 1) as int;
        let prefix = seq.take(n);
        let last = seq[n];
        ...
        lemma_push_not_contains_to_set(prefix, last);
        vstd::iset::fold::lemma_fold_insert(prefix.to_set().to_iset(),0int, f, last);
    }
}
    ...
    decreases seq.len(),
{
    ...
    if seq.len() == 0 {
        assert(seq.to_set() =~= Set::empty());
        vstd::iset::fold::lemma_fold_empty::<(A, B, i16), int>(0int, f);
    } else {
        let n = (seq.len() - 1) as int;
        let prefix = seq.take(n);
        let last = seq[n];
    ...
    decreases seq.len(),
{
    ...
    if seq.len() == 0 {
        assert(seq.to_set() =~= Set::empty());
        vstd::iset::fold::lemma_fold_empty::<(A, B, i32), int>(0int, f);
    } else {
        let n = (seq.len() - 1) as int;
        let prefix = seq.take(n);
        let last = seq[n];
    ...
    decreases seq.len(),
{
    ...
    if seq.len() == 0 {
        assert(seq.to_set() =~= Set::empty());
        vstd::iset::fold::lemma_fold_empty::<(A, B, i64), int>(0int, f);
    } else {
        let n = (seq.len() - 1) as int;
        let prefix = seq.take(n);
        let last = seq[n];
    ...
    decreases seq.len(),
{
    ...
    if seq.len() == 0 {
        assert(seq.to_set() =~= Set::empty());
        vstd::iset::fold::lemma_fold_empty::<(A, B, i128), int>(0int, f);
    } else {
        let n = (seq.len() - 1) as int;
        let prefix = seq.take(n);
        let last = seq[n];
    ...
    decreases seq.len(),
{
    ...
    if seq.len() == 0 {
        assert(seq.to_set() =~= Set::empty());
        vstd::iset::fold::lemma_fold_empty::<(A, B, isize), int>(0int, f);
    } else {
        let n = (seq.len() - 1) as int;
        let prefix = seq.take(n);
        let last = seq[n];
