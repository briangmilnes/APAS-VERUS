...
fn test_undirgraphmteph_basic_operations() {
    ...
    let a: SetStEph<Edge<usize>> = SetLit![Edge(0, 1), Edge(1, 2), Edge(2, 3)];
...
fn test_undirgraphmteph_incident_operations() {
    ...
    let a: SetStEph<Edge<usize>> = SetLit![Edge(0, 1), Edge(1, 2), Edge(0, 2)];
    let g = UnDirGraphMtEph::from_sets(v, a);
...
fn test_ng_single_edge() {
    ...
    let a: SetStEph<Edge<usize>> = SetLit![Edge(0, 1)];
    let g = UnDirGraphMtEph::from_sets(v, a);
...
fn test_ng_of_vertices_empty_set() {
    ...
    let empty_set: SetStEph<usize> = SetLit![];
...
fn test_undirgraphmteph_ngofvertices() {
    let v: SetStEph<usize> = SetLit![0, 1, 2, 3];
    let a: SetStEph<Edge<usize>> = SetLit![Edge(0, 1), Edge(1, 2), Edge(2, 3), Edge(0, 3)];
    let g = UnDirGraphMtEph::from_sets(v, a);

    let vertices_subset: SetStEph<usize> = SetLit![0, 1];
...
fn test_undirgraphmteph_nplusminusofvertices() {
    let v: SetStEph<usize> = SetLit![0, 1, 2, 3];
    let a: SetStEph<Edge<usize>> = SetLit![Edge(0, 1), Edge(1, 2), Edge(2, 0), Edge(3, 1)];
    let g = UnDirGraphMtEph::from_sets(v, a);
...
fn test_undirgraphmteph_edge_cases() {
    ...
    let a_empty: SetStEph<Edge<usize>> = SetLit![];
    ...
    let a_self: SetStEph<Edge<usize>> = SetLit![Edge(1, 1)];
...
fn test_undirgraphmteph_concurrent_access() {
    ...
    let a: SetStEph<Edge<usize>> = SetLit![
        Edge(0, 1),
        Edge(1, 2),
        Edge(2, 3),
        Edge(3, 4),
...
fn test_undirgraphmteph_complete_graph() {
    ...
    let v: SetStEph<usize> = SetLit![0, 1, 2, 3];
    let a: SetStEph<Edge<usize>> = SetLit![Edge(0, 1), Edge(0, 2), Edge(0, 3), Edge(1, 2), Edge(1, 3), Edge(2, 3)];
    let g = UnDirGraphMtEph::from_sets(v, a);
...
fn test_nplusofvertices() {
    let v: SetStEph<usize> = SetLit![0, 1, 2, 3];
    let e: SetStEph<Edge<usize>> = SetLit![Edge(0, 1), Edge(1, 2), Edge(2, 3)];
    let g = UnDirGraphMtEph::from_sets(v, e);
...
fn test_nminusofvertices() {
    ...
    let vertices_subset: SetStEph<usize> = SetLit![1, 2];
...
fn test_isolated_vertices() {
    let v: SetStEph<usize> = SetLit![1, 2, 3, 4, 5];
    let e: SetStEph<Edge<usize>> = SetLit![Edge(1, 2)];
    let g = UnDirGraphMtEph::from_sets(v, e);
...
fn test_disconnected_components() {
    ...
    let component1: SetStEph<usize> = SetLit![1, 2];
...
fn test_star_graph() {
    ...
    let v: SetStEph<usize> = SetLit![0, 1, 2, 3, 4];
    let e: SetStEph<Edge<usize>> = SetLit![Edge(0, 1), Edge(0, 2), Edge(0, 3), Edge(0, 4)];
    let g = UnDirGraphMtEph::from_sets(v, e);
...
fn test_cycle_graph() {
    ...
    let v: SetStEph<usize> = SetLit![0, 1, 2, 3];
    let e: SetStEph<Edge<usize>> = SetLit![Edge(0, 1), Edge(1, 2), Edge(2, 3), Edge(3, 0)];
    let g = UnDirGraphMtEph::from_sets(v, e);
...
fn test_path_graph() {
    ...
    let v: SetStEph<usize> = SetLit![1, 2, 3, 4, 5];
    let e: SetStEph<Edge<usize>> = SetLit![Edge(1, 2), Edge(2, 3), Edge(3, 4), Edge(4, 5)];
    let g = UnDirGraphMtEph::from_sets(v, e);
...
fn test_large_parallel_graph() {
    ...
    let mut v = SetStEph::<usize>::empty();
    let mut e = SetStEph::<Edge<usize>>::empty();
    ...
    let subset: SetStEph<usize> = SetLit![5, 10, 15];
...
#[test]
fn test_equality() {
    let v1: SetStEph<usize> = SetLit![1, 2, 3];
    let e1: SetStEph<Edge<usize>> = SetLit![Edge(1, 2), Edge(2, 3)];
    ...
    let e3: SetStEph<Edge<usize>> = SetLit![Edge(1, 2)];
...
fn test_multiple_self_loops() {
    let v: SetStEph<usize> = SetLit![1, 2];
    let e: SetStEph<Edge<usize>> = SetLit![Edge(1, 1), Edge(2, 2)];
    let g = UnDirGraphMtEph::from_sets(v, e);
