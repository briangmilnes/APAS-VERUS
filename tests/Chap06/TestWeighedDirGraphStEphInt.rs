...
fn test_from_weighed_edges() {
    ...
    let edges: SetStEph<WeightedEdge<usize, usize, i32>> = SetLit![WeightedEdge(1, 2, 10), WeightedEdge(2, 3, 20)];
...
fn test_add_weighed_edge() {
    let v: SetStEph<usize> = SetLit![1, 2, 3];
    let edges: SetStEph<WeightedEdge<usize, usize, i32>> = SetLit![];
...
fn test_out_neighbors_weighed() {
    ...
    let edges: SetStEph<WeightedEdge<usize, usize, i32>> = SetLit![WeightedEdge(1, 2, 10), WeightedEdge(1, 3, 15), WeightedEdge(2, 4, 20)];
    let g = WeighedDirGraphStEphInt::from_weighed_edges(v, edges);
...
fn test_in_neighbors_weighed() {
    let v: SetStEph<usize> = SetLit![1, 2, 3, 4];
    let edges: SetStEph<WeightedEdge<usize, usize, i32>> = SetLit![WeightedEdge(1, 2, 10), WeightedEdge(3, 2, 15), WeightedEdge(2, 4, 20)];
    let g = WeighedDirGraphStEphInt::from_weighed_edges(v, edges);
...
fn test_total_weight() {
    let v: SetStEph<usize> = SetLit![1, 2, 3];
    let edges: SetStEph<WeightedEdge<usize, usize, i32>> = SetLit![WeightedEdge(1, 2, 10), WeightedEdge(2, 3, 20), WeightedEdge(1, 3, 5)];
    let g = WeighedDirGraphStEphInt::from_weighed_edges(v, edges);
...
fn test_edges_above_weight() {
    let v: SetStEph<usize> = SetLit![1, 2, 3, 4];
    let edges: SetStEph<WeightedEdge<usize, usize, i32>> =
        SetLit![WeightedEdge(1, 2, 10), WeightedEdge(2, 3, 25), WeightedEdge(3, 4, 5), WeightedEdge(1, 4, 30)];
    let g = WeighedDirGraphStEphInt::from_weighed_edges(v, edges);

    let above15 = g.edges_above_weight(15);
    assert_eq!(above15.size(), 2);
    assert!(above15.mem(&WeightedEdge(2, 3, 25)));
    assert!(above15.mem(&WeightedEdge(1, 4, 30)));
}
...
fn test_edges_below_weight() {
    ...
    assert!(below15.mem(&WeightedEdge(1, 2, 10)));
    assert!(below15.mem(&WeightedEdge(3, 4, 5)));
}
...
fn test_zero_weight() {
    ...
    let edges: SetStEph<WeightedEdge<usize, usize, i32>> = SetLit![WeightedEdge(1, 2, 0)];
    let g = WeighedDirGraphStEphInt::from_weighed_edges(v, edges);
...
fn test_isolated_vertex() {
    let v: SetStEph<usize> = SetLit![1, 2, 3];
    let edges: SetStEph<WeightedEdge<usize, usize, i32>> = SetLit![WeightedEdge(1, 2, 10)];
    let g = WeighedDirGraphStEphInt::from_weighed_edges(v, edges);
...
fn test_self_loop() {
    let v: SetStEph<usize> = SetLit![1, 2];
    let edges: SetStEph<WeightedEdge<usize, usize, i32>> = SetLit![WeightedEdge(1, 1, 5), WeightedEdge(1, 2, 10)];
    let g = WeighedDirGraphStEphInt::from_weighed_edges(v, edges);
...
fn test_large_weights() {
    let v: SetStEph<usize> = SetLit![1, 2];
    let edges: SetStEph<WeightedEdge<usize, usize, i32>> = SetLit![WeightedEdge(1, 2, i32::MAX), WeightedEdge(2, 1, i32::MIN)];
    let g = WeighedDirGraphStEphInt::from_weighed_edges(v, edges);
...
fn test_weighed_path() {
    let v: SetStEph<usize> = SetLit![1, 2, 3, 4];
    let edges: SetStEph<WeightedEdge<usize, usize, i32>> = SetLit![WeightedEdge(1, 2, 5), WeightedEdge(2, 3, 10), WeightedEdge(3, 4, 15)];
    let g = WeighedDirGraphStEphInt::from_weighed_edges(v, edges);
...
fn test_weighed_star() {
    ...
    let edges: SetStEph<WeightedEdge<usize, usize, i32>> = SetLit![WeightedEdge(0, 1, 10), WeightedEdge(0, 2, 20), WeightedEdge(0, 3, 30)];
    let g = WeighedDirGraphStEphInt::from_weighed_edges(v, edges);
...
fn test_weigheddirgraphstephintlit_macro_empty() {
    let g: WeighedDirGraphStEphInt<usize> = WeighedDirGraphStEphIntLit!();
    assert_eq!(g.vertices().size(), 0);
}
...
fn test_weigheddirgraphstephintlit_macro_simple() {
    let g = WeighedDirGraphStEphIntLit!(
        V: [1, 2, 3],
        E: [WeightedEdge(1, 2, 10), WeightedEdge(2, 3, 20)]
    );
    assert_eq!(g.vertices().size(), 3);
...
fn test_weigheddirgraphstephintlit_macro_star() {
    let g = WeighedDirGraphStEphIntLit!(
        V: [0, 1, 2, 3],
        E: [WeightedEdge(0, 1, 5), WeightedEdge(0, 2, 10), WeightedEdge(0, 3, 15)]
    );
...
fn test_weigheddirgraphstephintlit_macro_trailing_comma() {
    let g = WeighedDirGraphStEphIntLit!(
        V: [1, 2, 3,],
        E: [WeightedEdge(1, 2, 100), WeightedEdge(2, 3, 200),]
    );
    assert_eq!(g.vertices().size(), 3);
