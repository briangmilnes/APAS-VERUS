...
fn test_from_weighed_edges() {
    ...
    let edges: SetStEph<WeightedEdge<N, i16>> = SetLit![WeightedEdge(1, 2, 10), WeightedEdge(2, 3, 20)];
...
fn test_add_weighed_edge() {
    let v: SetStEph<N> = SetLit![1, 2, 3];
    let edges: SetStEph<WeightedEdge<N, i16>> = SetLit![];
...
fn test_self_loop() {
    ...
    let edges: SetStEph<WeightedEdge<N, i16>> = SetLit![WeightedEdge(1, 1, 5)];
    let g = WeightedDirGraphStEphI16::from_weighed_edges(v, edges);
...
fn test_max_weight() {
    ...
    let edges: SetStEph<WeightedEdge<N, i16>> = SetLit![WeightedEdge(1, 2, 32767)];
    let g = WeightedDirGraphStEphI16::from_weighed_edges(v, edges);
    assert_eq!(g.labeled_arcs().size(), 1);
}
...
fn test_clone() {
    let v: SetStEph<N> = SetLit![1, 2];
    let edges: SetStEph<WeightedEdge<N, i16>> = SetLit![WeightedEdge(1, 2, 42)];
    let g = WeightedDirGraphStEphI16::from_weighed_edges(v, edges);
    let g2 = g.clone();
...
fn test_multiple_edges_same_source() {
    let v: SetStEph<N> = SetLit![1, 2, 3];
    let edges: SetStEph<WeightedEdge<N, i16>> =
