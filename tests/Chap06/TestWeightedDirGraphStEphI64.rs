...
//! Tests for WeightedDirGraphStEphI64.
...
fn test_from_weighed_edges() {
    ...
    let edges: SetStEph<WeightedEdge<usize, i64>> = SetLit![WeightedEdge(1, 2, 10), WeightedEdge(2, 3, 20)];
    let g = WeightedDirGraphStEphI64::from_weighed_edges(v, edges);
...
fn test_add_weighed_edge() {
    let v: SetStEph<usize> = SetLit![1, 2, 3];
    let edges: SetStEph<WeightedEdge<usize, i64>> = SetLit![];
    let mut g = WeightedDirGraphStEphI64::from_weighed_edges(v, edges);
...
fn test_self_loop() {
    ...
    let edges: SetStEph<WeightedEdge<usize, i64>> = SetLit![WeightedEdge(1, 1, 5)];
    let g = WeightedDirGraphStEphI64::from_weighed_edges(v, edges);
...
fn test_max_weight() {
    ...
    let edges: SetStEph<WeightedEdge<usize, i64>> =
        SetLit![WeightedEdge(1, 2, 9223372036854775807_i64)];
    let g = WeightedDirGraphStEphI64::from_weighed_edges(v, edges);
    assert_eq!(g.labeled_arcs().size(), 1);
}
...
fn test_clone() {
    let v: SetStEph<usize> = SetLit![1, 2];
    let edges: SetStEph<WeightedEdge<usize, i64>> = SetLit![WeightedEdge(1, 2, 42)];
    let g = WeightedDirGraphStEphI64::from_weighed_edges(v, edges);
    let g2 = g.clone();
