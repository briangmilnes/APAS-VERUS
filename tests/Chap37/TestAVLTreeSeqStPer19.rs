...
fn test_tabulate_and_map_ch19() {
    let _t: AVLTreeSeqStPerS<usize> = AVLTreeSeqStPerLit![0, 1, 2, 3, 4];
    let m: AVLTreeSeqStPerS<usize> = AVLTreeSeqStPerLit![0, 2, 4, 6, 8];
...
fn test_select_and_append_ch19() {
    let a: AVLTreeSeqStPerS<usize> = AVLTreeSeqStPerLit![0, 1, 2];
    let b: AVLTreeSeqStPerS<usize> = AVLTreeSeqStPerLit![3, 4, 5];
    ...
    let c: AVLTreeSeqStPerS<usize> = AVLTreeSeqStPerLit![0, 1, 2, 3, 4, 5];
...
fn test_deflate_and_filter_ch19() {
    let _t: AVLTreeSeqStPerS<usize> = AVLTreeSeqStPerLit![0, 1, 2, 3, 4, 5];
    let d: AVLTreeSeqStPerS<usize> = AVLTreeSeqStPerLit![2];
    let expected_d = AVLTreeSeqStPerLit![2];
    assert_eq!(d, expected_d);
    let f: AVLTreeSeqStPerS<usize> = AVLTreeSeqStPerLit![0, 1, 2];
