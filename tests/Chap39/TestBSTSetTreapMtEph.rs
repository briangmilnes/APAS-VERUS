...
#[test]
fn test_empty() {
    let set = BSTSetTreapMtEph::<i32>::empty();
...
#[test]
fn test_singleton() {
    let set = BSTSetTreapMtEph::singleton(42);
...
#[test]
fn test_union() {
    let mut set1 = BSTSetTreapMtEph::empty();
    set1.insert(1);
    set1.insert(2);
    let mut set2 = BSTSetTreapMtEph::empty();
    set2.insert(2);
    set2.insert(3);
...
fn test_union_empty() {
    let mut set1 = BSTSetTreapMtEph::empty();
    set1.insert(1);
    let set2 = BSTSetTreapMtEph::empty();
    let union = set1.union(&set2);
...
#[test]
fn test_join_pair() {
    let mut left = BSTSetTreapMtEph::empty();
    left.insert(1);
    left.insert(2);
    let mut right = BSTSetTreapMtEph::empty();
    right.insert(5);
    right.insert(6);
    let joined = BSTSetTreapMtEph::join_pair(left, right);
...
fn test_join_m() {
    ...
    let joined = BSTSetTreapMtEph::join_m(left, 5, right);
...
fn test_join_m_with_empty() {
    let empty = BSTSetTreapMtEph::empty();
    let mut right = BSTSetTreapMtEph::empty();
    right.insert(6);
    right.insert(7);

    let joined = BSTSetTreapMtEph::join_m(empty, 5, right);
...
fn test_trait_impl_empty() {
    let set: BSTSetTreapMtEph<i32> = <BSTSetTreapMtEph<i32> as BSTSetTreapMtEphTrait<i32>>::empty();
    assert_eq!(set.size(), 0);
}

#[test]
fn test_trait_impl_singleton() {
    let set = <BSTSetTreapMtEph<i32> as BSTSetTreapMtEphTrait<i32>>::singleton(42);
    assert_eq!(set.size(), 1);
    assert!(set.contains(&42));
}
...
fn test_trait_impl_insert() {
    let mut set = BSTSetTreapMtEph::empty();
    <BSTSetTreapMtEph<i32> as BSTSetTreapMtEphTrait<i32>>::insert(&mut set, 15);
    assert_eq!(set.size(), 1);
}
...
fn test_trait_impl_delete() {
    ...
    set.insert(10);
    set.insert(20);
    <BSTSetTreapMtEph<i32> as BSTSetTreapMtEphTrait<i32>>::delete(&mut set, &10);
    assert_eq!(set.size(), 1);
    assert!(!set.contains(&10));
}
...
fn test_trait_impl_union() {
    ...
    let result = <BSTSetTreapMtEph<i32> as BSTSetTreapMtEphTrait<i32>>::union(&set1, &set2);
...
fn test_trait_impl_intersection() {
    ...
    let result = <BSTSetTreapMtEph<i32> as BSTSetTreapMtEphTrait<i32>>::intersection(&set1, &set2);
...
fn test_trait_impl_difference() {
    ...
    let result = <BSTSetTreapMtEph<i32> as BSTSetTreapMtEphTrait<i32>>::difference(&set1, &set2);
    assert_eq!(result.size(), 1);
...
fn test_trait_impl_split() {
    ...
    let (left, found, right) = <BSTSetTreapMtEph<i32> as BSTSetTreapMtEphTrait<i32>>::split(&set, &5);
    assert!(found);
...
fn test_trait_impl_join_pair() {
    ...
    let result = <BSTSetTreapMtEph<i32> as BSTSetTreapMtEphTrait<i32>>::join_pair(left, right);
    assert_eq!(result.size(), 2);
}
...
fn test_trait_impl_join_m() {
    ...
    let result = <BSTSetTreapMtEph<i32> as BSTSetTreapMtEphTrait<i32>>::join_m(left, 3, right);
...
fn test_trait_impl_reduce() {
    ...
    let sum = <BSTSetTreapMtEph<i32> as BSTSetTreapMtEphTrait<i32>>::reduce(&set, |a, b| a + b, 0);
    assert_eq!(sum, 6);
}
...
fn test_trait_impl_iter_in_order() {
    ...
    let seq = <BSTSetTreapMtEph<i32> as BSTSetTreapMtEphTrait<i32>>::iter_in_order(&set);
