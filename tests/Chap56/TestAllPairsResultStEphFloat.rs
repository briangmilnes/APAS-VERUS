...
//!
//! Test suite for AllPairsResultStEphFloat.

use ordered_float::OrderedFloat;

use apas_verus::Chap19::ArraySeqStEph::ArraySeqStEph::*;
use apas_verus::Chap19::ArraySeqStPer::ArraySeqStPer::*;
use apas_verus::Chap56::AllPairsResultStEphFloat::AllPairsResultStEphFloat::*;
use apas_verus::Types::Types::*;

#[test]
fn test_new() {
    let result = AllPairsResultStEphFloat::new(3);
...
fn test_set_distance() {
    let mut result = AllPairsResultStEphFloat::new(3);
...
fn test_extract_path() {
    let mut result = AllPairsResultStEphFloat::new(4);
