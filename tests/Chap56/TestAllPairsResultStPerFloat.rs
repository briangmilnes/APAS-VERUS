...
//!
//! Test suite for AllPairsResultStPerFloat.

use ordered_float::OrderedFloat;

use apas_verus::Chap19::ArraySeqStPer::ArraySeqStPer::*;
use apas_verus::Chap56::AllPairsResultStPerFloat::AllPairsResultStPerFloat::*;
use apas_verus::Types::Types::*;

#[test]
fn test_new() {
    let result = AllPairsResultStPerFloat::new(3);
...
fn test_extract_path() {
    let result = AllPairsResultStPerFloat::new(4);
