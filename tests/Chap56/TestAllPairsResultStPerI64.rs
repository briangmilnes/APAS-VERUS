...
//!
//! Test suite for AllPairsResultStPerI64.

use apas_verus::Chap19::ArraySeqStPer::ArraySeqStPer::*;
use apas_verus::Chap56::AllPairsResultStPerI64::AllPairsResultStPerI64::*;
use apas_verus::Types::Types::*;

#[test]
fn test_new() {
    let result = AllPairsResultStPerI64::new(3);
...
fn test_extract_path() {
    let result = AllPairsResultStPerI64::new(4);
