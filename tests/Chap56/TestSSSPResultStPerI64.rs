...
//!
//! Test suite for SSSPResultStPerI64.

use apas_verus::Chap19::ArraySeqStPer::ArraySeqStPer::*;
use apas_verus::Chap56::SSSPResultStPerI64::SSSPResultStPerI64::*;
use apas_verus::Types::Types::*;

#[test]
fn test_new() {
    let result = SSSPResultStPerI64::new(5, 0);
...
fn test_set_distance() {
    let result = SSSPResultStPerI64::new(3, 0);
...
fn test_extract_path() {
    let result = SSSPResultStPerI64::new(4, 0);
